...
if __name__ == "__main__":
    ...
    stocks_to_analyze = ["RGC","DRUG","QUBT","DFDV","QBTS","RGTI","TDUP","TGEN","NUTX","MNPR","ZEPP","NEON","MVST","PRCH","AREN","ABVX","NEGG","CELC","MENS","ZIMV","SBET","MP","KOD","AMPX","ZBIO","AFRM","UPST","SOFI","FUTU","RIOT","COIN","CLSK","XPEV","LI","BE","RKLB","PLTR","GEV","AXON","DASH","HWM","CEG","CRWD","NVDA","WDC","ANET","TSLA","AEHR","SHOP","UBER","CVNA","MSTR","CRSP","NTLA","EDIT","CHPT","TMDX","SMCI","VKTX","JBL","TPR","AMD","MRVL","IONQ","MDB","MNDY","PSTG","ZS","CELH","OPRA","PACB","GTLB","DDOG","IOT","GLBE","FSR","EXAS","BBIO","INMD","NU","JOBY","APP","ELF","AVDL","BSGM","PHVS","SE","GRAB","BILI","ORCL","NFLX","NVTS","RCL","AVGO","PANW","SNOW","AI","ENPH","SEDG","ONON","PERI"]
